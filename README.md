...
## Related projects
The autogenerated JATS xml file that this project aims to generate is to be used with the jats2epub package.

I am also working on an automatic tagging solution using Open Document Format as a base.
